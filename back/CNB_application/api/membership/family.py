...
class Family(Resource):
    ...
    @authenticated
    def post(self):
        family_object = family.create_family(first_name=request.args.get('first_name'),
                                             last_name=request.args.get('last_name'),
    ...
    def put(self):
        ...
        family.update_family(family_id=family_id,
                             first_name=request.args.get('first_name'),
                             last_name=request.args.get('last_name'),
                             email=request.args.get('email'),
                             phone_number=request.args.get('phone_number'),
                             benefactor_member=request.args.get('benefactor_member'),
                             parking=request.args.get('parking'))
        address.update_address(family_id=family_id,
                               address=request.args.get('address'),
                               city=request.args.get('city'),
                               zip_code=request.args.get('zip_code'),
                               country=request.args.get('country'))
