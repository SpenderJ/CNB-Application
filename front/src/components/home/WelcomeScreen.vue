                ...
                <v-row justify="center" align="center" :class="!build && translateUp ? 'translate-up' : ''">
                    <v-fade-transition>
                        <div
                                ...
                                style="width: 180px"
                        >
                  <span class="display-1 font-weight-thin mb-4 white--text">
                    Hi <span class="font-weight-bold white--text">{{ username }}</span>,
                  </span>
                        </div>
                    </v-fade-transition>
                    <v-fade-transition>
                        <div v-if="welcome" class="appear" style="width: 320px">
                            <span class="display-1 font-weight-light mb-1 white--text">welcome to the CNB</span>
                        </div>
                    </v-fade-transition>
                </v-row>
                <v-fade-transition>
                    <h4 class="subheading appear mt-4" style="width: 100%" v-if="build">
                        Now the fun begins, enjoy our nautic club and your experience !
                    </h4>
                </v-fade-transition>
            </v-col>
        </v-row>
